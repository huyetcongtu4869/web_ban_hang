...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?url=home">
                ...
                <div class="sidebar-brand-text mx-3">Tun <sup>Tun</sup></div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('route_product')}}">
                    <i class="fas fa-phone"></i>
                    <span>Quản lí Quần Áo</span></a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('route_coupon')}}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tun Tun</span>
                                <img class="rounded-circle" width="50px" src="{{ asset('img/ava.jpg') }}">
                            </a>
    ...
    <script src="{{ asset('bootstrap/js/chart-area-demo.js') }}"></script>
    <script src="{{ asset('libs/jquery/dist/jquery.min.js') }}"></script>
    <script src="{{ asset('libs/input-mask/jquery.inputmask.js') }}"></script>
    <script>
        function getDataChart(type = 'month') {
            $.ajax({
                url: "index.php?url=get_chart_data&type=" + type,
